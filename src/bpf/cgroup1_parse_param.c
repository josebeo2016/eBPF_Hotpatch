...
int kprobe__cgroup1_parse_param(struct pt_regs *ctx, struct fs_context *fc, struct fs_parameter *param) {
    ...
    //https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=a41573667b39152176f6b08d10b4deb171e541c4
    int opt;
